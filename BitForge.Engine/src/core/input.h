...
// keyboard input
BFAPI b8 input_is_key_down(keys key);
BFAPI b8 input_is_key_up(keys key);
BFAPI b8 input_was_key_down(keys key);
BFAPI b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

// mouse input
BFAPI b8 input_is_button_down(buttons button);
BFAPI b8 input_is_button_up(buttons button);
BFAPI b8 input_was_button_down(buttons button);
BFAPI b8 input_was_button_up(buttons button);
BFAPI void input_get_mouse_position(i32* x, i32* y);
BFAPI void input_get_previous_mouse_position(i32* x, i32* y);
